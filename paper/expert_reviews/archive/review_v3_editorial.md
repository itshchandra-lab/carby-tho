...
> **RETIREMENT STATUS:** ✓ RETIRED — all pre-submission blockers addressed in current draft

| # | Issue | Severity | Status |
|---|-------|----------|--------|
| 1 | §6.8 Limitations missing | CRITICAL | ✓ ADDRESSED — §6.8 present with USA-driven finding, EUA provenance, ZA small-sample caveat |
| 2 | β=84.0 not stated at §6.2 | HIGH | ✓ ADDRESSED — β=84.0 (SE=37.89, 95% CI [9.8, 158.2]) at §6.2 result announcement |
| 3 | LOO jackknife absent | HIGH | ✓ ADDRESSED — §6.1 discloses "removing USA reverses pooled coefficient from +84 to −3" |
| 4 | p_t not operationalized | HIGH | ✓ ADDRESSED — §3.2 treats p_t as scenario parameter; §7.7 Low/Base/High scenarios are p_t sensitivity |
| 5 | §2 "Four Literatures" mismatch | MEDIUM | ✓ ADDRESSED — retitled "Five Literatures"; §2.6 heading updated |
| 6 | Figure 5 missing | MEDIUM | ✓ ADDRESSED — `figure_5_mpi_trajectories.png` exists; described at §8.2 |
| 7 | Hirschman (1945) absent | HIGH | ✓ ADDRESSED — cited §2.4; entry in references |
| 8 | Baldwin (1985) absent | HIGH | ✓ ADDRESSED — cited §2.4; entry in references |
| 9 | Polanyi not in references | HIGH | ✓ ADDRESSED — entry added to references |
| 10 | Orphan references (Abdelal, Mearsheimer, Maggiori et al. 2020) | MEDIUM | ✓ ADDRESSED — removed from reference list; Helleiner/Ikenberry/Kirshner now cited in text |
| 11 | Citation style mismatch (APSA vs APA) | HIGH | ✓ ADDRESSED — reference list standardised to APSA format throughout |
| 12 | Pforr et al. (2025) missing page range | LOW | ✓ ADDRESSED — "Advance access" noted |
| 13 | §2.2 Strange sentence promotion | LOW | DEFERRED — line-edit only; not a pre-submission blocker |
| 14 | §6.6 Japan/UK non-sig prose | MEDIUM | DEFERRED — current prose technically accurate; substantive text at §6.8 covers this |
| 15 | §9 Russia thread | LOW | DEFERRED — minor rhetorical preference; not a pre-submission blocker |
